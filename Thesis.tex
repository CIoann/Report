...
\include{Chapter2}                                 	%The Patmos processor
\include{Chapter3}                                 	%The Operating System
\include{Chapter4}                                 	%Processor extension
%\include{Chapter5}                                 	%TiCOS extension
%\include{Chapter6}                                 	%Source code access
%\include{Chapter7}                                 	%Conclusion
\appendix
%\include{Appendix1}                                 %Appendix A
%\include{Appendix2}                                 %Appendix B
%-----------
% Backmatter
%-----------
\backmatter
